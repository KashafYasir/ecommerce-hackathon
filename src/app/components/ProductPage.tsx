    ...
    <div className="product-page">
      ...
      <div className="product-details">
        ...
        <div className="social-icons">
          <img src="https://dashboard.codeparrot.ai/api/assets/Z1XET4wTRzcMVVtJ" alt="Facebook" width="20" height="20" />
          <img src="https://dashboard.codeparrot.ai/api/assets/Z1XET4wTRzcMVVtK" alt="Twitter" width="25" height="25" />
          <img src="https://dashboard.codeparrot.ai/api/assets/Z1XET4wTRzcMVVtL" alt="LinkedIn" width="20" height="20" />
        </div>
      </div>
    </div>
  );
